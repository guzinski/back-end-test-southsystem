...
public class FileParserServiceTest {
    ...
    public void testParseFile() throws Exception {
        ...
        assertThat(parsedFile.getCustomers(), hasSize(2));
        ...
        assertThat(parsedFile.getCustomers().get(0).getName(), equalTo("Jose da Silva"));
        assertThat(parsedFile.getCustomers().get(1).getName(), equalTo("Eduardo Pereira"));
        assertThat(parsedFile.getCustomers().get(0).getBusinessArea(), equalTo("Rural"));
        assertThat(parsedFile.getCustomers().get(1).getBusinessArea(), equalTo("Rural"));
